...
import BottomSheet from "../bottonsheet/bottomsheet";
import { IoMdArrowDropdown } from "react-icons/io";
import { useNavigate } from 'react-router-dom';
import { formatLaoKip } from '../../../utils/format_number'
import { ShimmerPayment } from ".././animation/shimmer/shimmer";
...
const PaymentComponent: React.FC<PaymentComponentProps> = ({ isOpen, onClose, selectedPackage, selectedItem }) => {
    ...
    return (
        <BottomSheet isOpen={isOpen} onClose={onClose}>
            {paymentMethods === null || paymentMethods.length === 0 ? <ShimmerPayment /> : (
